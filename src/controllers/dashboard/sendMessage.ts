...
export const sendMessageController = async (req: Request, res: Response) => {
    ...
    const messageData = await messageRepository.findOneByOrFail({ id: Number(messageId) }).catch(err => {
...
export const sendTransportMessageController = async (req: Request, res: Response) => {
    const messageId = req.body.messageId;
