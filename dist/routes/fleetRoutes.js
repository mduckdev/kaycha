...
const fleet_1 = require("../controllers/fleet/fleet");
...
function fleetRoutes() {
    ...
    router.get("/", new fleet_1.Fleet().getIndex);
    router.get("/edit/:id", new fleet_1.Fleet().getEdit);
    router.get("/add", new fleet_1.Fleet().getAdd);
    router.put('/add', new fleet_1.Fleet().put);
    router.patch('/edit/:id', new fleet_1.Fleet().patch);
    router.delete("/delete/:id", new fleet_1.Fleet().delete);
    return router;
}
