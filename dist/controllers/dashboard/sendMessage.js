...
exports.sendTransportMessageController = exports.sendMessageController = void 0;
...
const sendTransportMessageController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const messageId = req.body.messageId;
    ...
    let destinationEmail = null;
    if (!((_b = req.session.user) === null || _b === void 0 ? void 0 : _b.email) || req.session.user.email == "") {
        destinationEmail = process.env.EMAIL_DESTINATION;
    }
    else {
        destinationEmail = req.session.user.email;
    ...
    const plainTextMessage = `Dane klienta: ${messageData.firstName} ${messageData.lastName}
        Nr telefonu: ${messageData.phoneNumber}
        Adres załadunku: ${messageData.loadingAddress}
        Adres rozładunku: ${messageData.unloadingAddress}
        Treść wiadomości:
        ${messageData.message}`;
    const htmlMessage = `
        <!DOCTYPE html>
        ...
        <body>
            ...
            <ul>
                <li>🗄️ Dane klienta: ${messageData.firstName} ${messageData.lastName}</li>
                <li>☎️ Nr telefonu: ${messageData.phoneNumber}</li>
                <li>📦 Adres załadunku: ${messageData.loadingAddress}</li>
                <li>🚚 Adres rozładunku: ${messageData.unloadingAddress}</li>
            </ul>
            <h2>ℹ️ Treść wiadomości:</h2>
            <p>${messageData.message}</p>
        </body>
...
exports.sendTransportMessageController = sendTransportMessageController;
